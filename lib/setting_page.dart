...
import 'package:spiritlevel/ad_ump_status.dart';
...
class _SettingPageState extends State<SettingPage> {
  ...
  void _initState() async {
    ...
    _scaleType = Model.scaleType;
    _tweakX = Model.tweakX;
    _tweakY = Model.tweakY;
  ...
  Future<void> _onApply() async {
    await Model.setSensitivity(_sensitivity);
    await Model.setScaleType(_scaleType);
    await Model.setTweakX(_tweakX);
    await Model.setTweakY(_tweakY);
  ...
  Widget _buildSensitivity(AppLocalizations l) {
    return Card(
  ...
  Widget _buildScaleType(AppLocalizations l) {
    return Card(
      margin: const EdgeInsets.only(left: 0, top: 12, right: 0, bottom: 0),
      color: _themeColor.cardColor,
      elevation: 0,
      ...
      child: Column(
        children: [
          ...
          Padding(
            ...
            child: Row(
              children: <Widget>[
                Text(_scaleType.toStringAsFixed(0)),
                Expanded(
                  child: Slider(
  ...
  Widget _buildTweak(AppLocalizations l) {
    return Column(
      children: [
        Card(
          margin: const EdgeInsets.only(left: 0, top: 12, right: 0, bottom: 0),
          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: Row(
                  children: <Widget>[
                    Text(_tweakX.toStringAsFixed(1)),
                    Expanded(
                      child: Slider(
                        value: _tweakX.toDouble(),
                        min: -5.0,
                        max: 5.0,
                        divisions: 20,
                        label: _tweakX.toStringAsFixed(1),
                        onChanged: (double value) {
                          setState(() {
                            _tweakX = value;
                          });
          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: Row(
                  children: <Widget>[
                    Text(_tweakY.toStringAsFixed(1)),
                    Expanded(
                      child: Slider(
                        value: _tweakY.toDouble(),
                        min: -5.0,
                        max: 5.0,
                        divisions: 20,
                        label: _tweakY.toStringAsFixed(1),
                        onChanged: (double value) {
                          setState(() {
                            _tweakY = value;
                          });
