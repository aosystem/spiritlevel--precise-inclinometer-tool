...
class ThemeColor {
  ...
  //main page
  Color get mainBackColor => _isLight ? Color.fromRGBO(170, 170, 170, 1.0) : Color.fromRGBO(17, 17, 17, 1.0);
  Color get mainForeColor => _isLight ? Colors.grey[200]! : Colors.grey[500]!;
  //setting page
